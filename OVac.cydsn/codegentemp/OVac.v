...
module emFile_v1_20_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("63e6227f-fc93-4497-8db2-37d313a0b315/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("63e6227f-fc93-4497-8db2-37d313a0b315/5ed615c6-e1f0-40ed-8816-f906ef67d531"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(1),
		  .period("0"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63e6227f-fc93-4497-8db2-37d313a0b315/1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63e6227f-fc93-4497-8db2-37d313a0b315/ae249072-87dc-41aa-9405-888517aefa28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63e6227f-fc93-4497-8db2-37d313a0b315/6df85302-e45f-45fb-97de-4bdf3128e07b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=5, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=419999999, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=32, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Timer_v2_70, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=adjust_timer, CY_INSTANCE_SHORT_NAME=adjust_timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=adjust_timer, )
module Timer_v2_70_6 (
    ...
    B_Timer_v2_70 TimerUDB (
        ...
        .tc(Net_53),
        .clock(clock));
    defparam TimerUDB.Capture_Count = 5;
    defparam TimerUDB.CaptureCounterEnabled = 0;
    defparam TimerUDB.CaptureMode = 0;
    defparam TimerUDB.EnableMode = 0;
    defparam TimerUDB.InterruptOnCapture = 0;
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Comp_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp, CY_INSTANCE_SHORT_NAME=Comp, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=Comp, )
module Comp_v2_0_7 (
    Vplus,
    CmpOut,
    Vminus,
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ccfe27d4-70ee-42dc-a422-0465741d6615"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_70_2 Sample_Timer (
        ...
        .tc(Net_84),
        .clock(Net_10));
    defparam Sample_Timer.CaptureCount = 2;
    defparam Sample_Timer.CaptureCounterEnabled = 0;
    defparam Sample_Timer.DeviceFamily = "PSoC5";
    defparam Sample_Timer.InterruptOnCapture = 0;
    defparam Sample_Timer.InterruptOnTC = 1;
    defparam Sample_Timer.Resolution = 16;
    defparam Sample_Timer.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("23c2f2c2-5ede-491d-a094-a426718bf8f4"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Solenoid_1_net;
	wire [0:0] tmpFB_0__Solenoid_1_net;
	wire [0:0] tmpIO_0__Solenoid_1_net;
	wire [0:0] tmpINTERRUPT_0__Solenoid_1_net;
	electrical [0:0] tmpSIOVREF__Solenoid_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Solenoid_1
		 (.oe(tmpOE__Solenoid_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Solenoid_1_net[0:0]}),
		  .io({tmpIO_0__Solenoid_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Solenoid_1_net),
		  .interrupt({tmpINTERRUPT_0__Solenoid_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Solenoid_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    emFile_v1_20_4 emFile ();
	...
	cy_psoc3_pins_v1_10
		#(.id("64730f14-e8b9-4cc5-b238-09742c8930c1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_70_5 Countdown_timer (
        ...
        .tc(Net_106),
        .clock(Net_98));
    defparam Countdown_timer.CaptureCount = 2;
    defparam Countdown_timer.CaptureCounterEnabled = 0;
    defparam Countdown_timer.DeviceFamily = "PSoC5";
    defparam Countdown_timer.InterruptOnCapture = 0;
    defparam Countdown_timer.InterruptOnTC = 1;
    defparam Countdown_timer.Resolution = 32;
    defparam Countdown_timer.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__LED2_1_net;
	wire [0:0] tmpFB_0__LED2_1_net;
	wire [0:0] tmpIO_0__LED2_1_net;
	wire [0:0] tmpINTERRUPT_0__LED2_1_net;
	electrical [0:0] tmpSIOVREF__LED2_1_net;

	cy_psoc3_pins_v1_10
		#(.id("ffcd5137-cefb-4994-b319-b5a6493f8192"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED2_1
		 (.oe(tmpOE__LED2_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED2_1_net[0:0]}),
		  .io({tmpIO_0__LED2_1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED2_1_net),
		  .interrupt({tmpINTERRUPT_0__LED2_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED2_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("44953843-4ee0-4902-ab5a-b59940454703"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    Timer_v2_70_6 adjust_timer (
        ...
        .tc(Net_125),
        .clock(Net_117));
    defparam adjust_timer.CaptureCount = 5;
    defparam adjust_timer.CaptureCounterEnabled = 0;
    defparam adjust_timer.DeviceFamily = "PSoC5";
    defparam adjust_timer.InterruptOnCapture = 0;
    defparam adjust_timer.InterruptOnTC = 0;
    defparam adjust_timer.Resolution = 32;
    defparam adjust_timer.SiliconRevision = "0";

	wire [0:0] tmpOE__Solenoid_2_net;
	wire [0:0] tmpFB_0__Solenoid_2_net;
	wire [0:0] tmpIO_0__Solenoid_2_net;
	wire [0:0] tmpINTERRUPT_0__Solenoid_2_net;
	electrical [0:0] tmpSIOVREF__Solenoid_2_net;

	cy_psoc3_pins_v1_10
		#(.id("4aca01e7-38ba-4c48-b7e2-1080606884cf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Solenoid_2
		 (.oe(tmpOE__Solenoid_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Solenoid_2_net[0:0]}),
		  .io({tmpIO_0__Solenoid_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Solenoid_2_net),
		  .interrupt({tmpINTERRUPT_0__Solenoid_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Solenoid_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("7eb1eabb-d37a-40f7-b7f2-cbc50ba086cc"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
	...
	wire [0:0] tmpOE__M_Pin_net;
	wire [0:0] tmpFB_0__M_Pin_net;
	wire [0:0] tmpIO_0__M_Pin_net;
	wire [0:0] tmpINTERRUPT_0__M_Pin_net;
	electrical [0:0] tmpSIOVREF__M_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		M_Pin
		 (.oe(tmpOE__M_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_Pin_net[0:0]}),
		  .analog({Net_178}),
		  .io({tmpIO_0__M_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__M_Pin_net),
		  .interrupt({tmpINTERRUPT_0__M_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2d48f498-f7bf-449c-9f8c-6ee8e3e3e2e8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    UART_v2_50_8 UART (
        ...
        .reset(1'b0),
        .rx(Net_224),
        .tx_interrupt(Net_225),
        .rx_interrupt(Net_226),
        .tx_data(Net_227),
        .tx_clk(Net_228),
        .rx_data(Net_229),
        .rx_clk(Net_230));
